...
const Header = ({price,handlePrice}) => {
  return (
    <header className="my-10 w-[1320px] mx-auto ">
      ...
      {/* banner section  */}
      <section
        className="py-16 text-white space-y-4 bg-cover bg-no-repeat flex flex-col justify-center items-center rounded-2xl"
        style={{ backgroundImage: `url(${hero})`, backgroundColor: "black" }}
      >
        <div>
          <img src={banner} alt="" />
        </div>
